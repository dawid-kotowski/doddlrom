...
train_valid_data = dr.FetchTrainAndValidSet(0.8)
stat_train_valid_data = dr.StatFetchTrainAndValidSet(0.8)
...
DOD_DL_trainer = dr.DOD_DL_Trainer(DOD_DL_model, train_valid_data, N_A, 
                                   epochs=2,restart=2, learning_rate=1e-3, 
                                   batch_size=128)
