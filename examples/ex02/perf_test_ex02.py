...
G = np.load('examples/ex02/training_data/gram_matrix_ex02.npy', allow_pickle=True)
A_np = np.load('examples/ex02/training_data/ambient_matrix_ex02.npy', allow_pickle=True)
...
l2_norm = dr.L2Norm(np.load('examples/ex02/training_data/gram_matrix_ex02.npy', allow_pickle=True))
...
for n in tqdm(n_set, desc="Reduced Dimension"):
    ...
    DOD_DL_trainer = dr.DOD_DL_Trainer(DOD_DL_model, train_valid_data, N_A, 'ex02',
...
plt.savefig('/home/sereom/Documents/University/Studies/Mathe/Wissenschaftliche Arbeiten/Master/Masterarbeit Ohlberger/Programming/master-project-1/examples/ex02/benchmarks/performance.png', dpi=300, bbox_inches='tight')
...
--------------------
'''
with open("/home/sereom/Documents/University/Studies/Mathe/Wissenschaftliche Arbeiten/Master/Masterarbeit Ohlberger/Programming/master-project-1/examples/ex02/benchmarks/benchmark_timed.pkl", "wb") as f:
