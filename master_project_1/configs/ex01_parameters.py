...
# Build DOD-DL-ROM triple (Coeff DFNN -> n, AE: N' <-> n)
...
# Build POD-DL (Coeff DFNN -> n, AE: N_A <-> n)
pod_coeff_kwargs = P.make_pod_DFNN_kwargs()          # DFNN -> n
pod_enc_kwargs   = P.make_pod_Encoder_kwargs()       # Encoder: N_A -> n
pod_dec_kwargs   = P.make_pod_Decoder_kwargs()       # Decoder: n   -> N_A
