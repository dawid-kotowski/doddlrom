...
EX04_PRESETS: Dict[str, Dict[str, Any]] = {
    "baseline": {
        "preprocess_dim": 2,
        "dod_structure": [360, 180, 90],
        "df_layers": [60, 30, 16],
        "dod_dl_df_layers": [30, 15, 8],
        "dod_in_channels": 1,
        "dod_hidden_channels": 30,
        "dod_kernel": 3, "dod_stride": 1, "dod_padding": 1,
        "dod_num_layers": 1,
        "pod_df_layers": [90, 45, 23],
        "pod_in_channels": 1,
        "pod_hidden_channels": [30, 60],
        "pod_kernel": [3, 3], "pod_stride": [1, 2], "pod_padding": [1, 1],
        "pod_num_layers": 2,
        "L": 3,
        "stat_dod_structure": [950, 475],
        "stat_phi_n_structure": [120, 60, 30],
    },
    "test1": {
        "preprocess_dim": 2,
        "dod_structure": [12, 6],
        "df_layers": [4, 2],
        "dod_dl_df_layers": [3, 2],
        "dod_in_channels": 1,
        "dod_hidden_channels": 2,
        "dod_kernel": 3, "dod_stride": 1, "dod_padding": 1,
        "dod_num_layers": 1,
        "pod_df_layers": [6, 3],
        "pod_in_channels": 1,
        "pod_hidden_channels": [3, 3],
        "pod_kernel": [3, 3], "pod_stride": [1, 2], "pod_padding": [1, 1],
        "pod_num_layers": 2,
        "L": 3,
        "stat_dod_structure": [110, 55],
        "stat_phi_n_structure": [14, 7, 4],
    },
    "test2": {
        "preprocess_dim": 2,
        "dod_structure": [16, 8],
        "df_layers": [5, 3],
        "dod_dl_df_layers": [4, 2],
        "dod_in_channels": 1,
        "dod_hidden_channels": 3,
        "dod_kernel": 3, "dod_stride": 1, "dod_padding": 1,
        "dod_num_layers": 1,
        "pod_df_layers": [8, 4],
        "pod_in_channels": 1,
        "pod_hidden_channels": [4, 4],
        "pod_kernel": [3, 3], "pod_stride": [1, 2], "pod_padding": [1, 1],
        "pod_num_layers": 2,
        "L": 3,
        "stat_dod_structure": [128, 64],
    ...
    "test14": {
        "preprocess_dim": 2,
        "dod_structure": [116, 58],
        "df_layers": [39, 20],
        "dod_dl_df_layers": [22, 11],
        "dod_in_channels": 1,
        "dod_hidden_channels": 22,
        "dod_kernel": 3, "dod_stride": 1, "dod_padding": 1,
        "dod_num_layers": 1,
    ...
    "test15": {
        "preprocess_dim": 2,
        "dod_structure": [134, 67],
        "df_layers": [45, 23],
        "dod_dl_df_layers": [25, 13],
        "dod_in_channels": 1,
        "dod_hidden_channels": 24,
        "dod_kernel": 3, "dod_stride": 1, "dod_padding": 1,
        "dod_num_layers": 1,
    ...
    "test16": {
        ...
        "dod_kernel": 3, "dod_stride": 1, "dod_padding": 1,
        "dod_num_layers": 1,
        "pod_df_layers": [76, 38, 19],
        "pod_in_channels": 1,
        "pod_hidden_channels": [27, 27],
        "pod_kernel": [3, 3], "pod_stride": [1, 2], "pod_padding": [1, 1],
        "pod_num_layers": 2,
        "L": 3,
        "stat_dod_structure": [668, 334],
    ...
    "test17": {
        ...
        "dod_kernel": 3, "dod_stride": 1, "dod_padding": 1,
        "dod_num_layers": 1,
        "pod_df_layers": [87, 44, 22],
        "pod_in_channels": 1,
        "pod_hidden_channels": [29, 29],
        "pod_kernel": [3, 3], "pod_stride": [1, 2], "pod_padding": [1, 1],
        "pod_num_layers": 2,
        "L": 3,
        "stat_dod_structure": [737, 371],
    ...
    "test19": {
        "preprocess_dim": 2,
        "dod_structure": [210, 105, 53],
        "df_layers": [67, 34, 17],
        "dod_dl_df_layers": [36, 18, 9],
        "dod_in_channels": 1,
        "dod_hidden_channels": 32,
        "dod_kernel": 3, "dod_stride": 1, "dod_padding": 1,
        "dod_num_layers": 1,
        "pod_df_layers": [106, 53, 27],
        "pod_in_channels": 1,
        "pod_hidden_channels": [33, 33],
        "pod_kernel": [3, 3], "pod_stride": [1, 2], "pod_padding": [1, 1],
        "pod_num_layers": 2,
        "L": 3,
        "stat_dod_structure": [890, 445],
    ...
    "test20": {
        "preprocess_dim": 2,
        "dod_structure": [220, 110, 55],
        "df_layers": [70, 35, 18],
        "dod_dl_df_layers": [38, 19, 10],
        "dod_in_channels": 1,
        "dod_hidden_channels": 34,
        "dod_kernel": 3, "dod_stride": 1, "dod_padding": 1,
        "dod_num_layers": 1,
        "pod_df_layers": [112, 56, 28],
        "pod_in_channels": 1,
        "pod_hidden_channels": [35, 35],
        "pod_kernel": [3, 3], "pod_stride": [1, 2], "pod_padding": [1, 1],
        "pod_num_layers": 2,
        "L": 3,
        "stat_dod_structure": [950, 475],
...
class Ex04Parameters:
    ...
    def __post_init__(self) -> None:
        preset = EX04_PRESETS.get(self.profile, {})
        for k, v in preset.items():
            if hasattr(self, k):
                setattr(self, k, v)
