...
EX04_PRESETS: Dict[str, Dict[str, Any]] = {
    ...
    "test9": {
        ...
        "dod_structure": [32, 16],
        "df_layers": [11, 5],
        "dod_dl_df_layers": [11, 5],
        "dod_in_channels": 1,
        "dod_hidden_channels": [2, 2],
    ...
    "test13": {
        ...
        "dod_structure": [32, 16],
        "df_layers": [15, 7],
        "dod_dl_df_layers": [15, 7],
        "dod_in_channels": 1,
        "dod_hidden_channels": [2, 3],
        "dod_kernel": [3, 3], "dod_stride": [1, 2], "dod_padding": [1, 1],
        "dod_num_layers": 2,
        "pod_df_layers": [15, 7],
        "pod_in_channels": 1,
        "pod_hidden_channels": [8, 11],
        "pod_kernel": [3, 3], "pod_stride": [1, 2], "pod_padding": [1, 1],
        "pod_num_layers": 2,
        "L": 3,
        "stat_dod_structure": [493, 249],
