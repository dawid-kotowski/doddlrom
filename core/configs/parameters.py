...
EX02_PRESETS: Dict[str, Dict[str, Any]] = {
    ...
    "test2": {
        ...
        "pod_df_layers": [14, 7],
        "pod_in_channels": 1,
        "pod_hidden_channels": [5, 10],
        "pod_kernel": [3, 3], "pod_stride": [1, 2], "pod_padding": [1, 1],
        "pod_num_layers": 2,
        "L": 3,
        "stat_dod_structure": [154, 77],
        "stat_phi_n_structure": [19, 10, 8],
    },
    "test3": {
        "preprocess_dim": 2,
        "dod_structure": [34, 17],
        ...
        "pod_df_layers": [17, 8],
        "pod_in_channels": 1,
        "pod_hidden_channels": [6, 11],
        "pod_kernel": [3, 3], "pod_stride": [1, 2], "pod_padding": [1, 1],
        "pod_num_layers": 2,
        "L": 3,
        "stat_dod_structure": [179, 90],
        "stat_phi_n_structure": [22, 11, 8],
    },
    "test4": {
        "preprocess_dim": 2,
        "dod_structure": [38, 19],
        ...
        "pod_df_layers": [19, 10],
        "pod_in_channels": 1,
        "pod_hidden_channels": [6, 13],
        "pod_kernel": [3, 3], "pod_stride": [1, 2], "pod_padding": [1, 1],
        "pod_num_layers": 2,
        "L": 3,
        "stat_dod_structure": [205, 102],
        "stat_phi_n_structure": [26, 13, 8],
    },
    "test5": {
        "preprocess_dim": 2,
        "dod_structure": [43, 22],
        ...
        "pod_num_layers": 2,
        "L": 3,
        "stat_dod_structure": [230, 115],
        "stat_phi_n_structure": [29, 14, 8],
    },
    "test6": {
        "preprocess_dim": 2,
        "dod_structure": [46, 23],
        ...
        "pod_df_layers": [23, 11],
        "pod_in_channels": 1,
        "pod_hidden_channels": [8, 15],
        "pod_kernel": [3, 3], "pod_stride": [1, 2], "pod_padding": [1, 1],
        "pod_num_layers": 2,
        "L": 3,
        "stat_dod_structure": [243, 122],
        "stat_phi_n_structure": [30, 15, 8],
    },
    "test7": {
        "preprocess_dim": 2,
        "dod_structure": [48, 24],
    ...
    "test8": {
        ...
        "pod_num_layers": 2,
        "L": 3,
        "stat_dod_structure": [282, 141],
        "stat_phi_n_structure": [35, 18, 9],
    },
    "test9": {
        "preprocess_dim": 2,
        "dod_structure": [58, 29],
        ...
        "pod_df_layers": [29, 14],
        "pod_in_channels": 1,
        "pod_hidden_channels": [10, 19],
        "pod_kernel": [3, 3], "pod_stride": [1, 2], "pod_padding": [1, 1],
        "pod_num_layers": 2,
        "L": 3,
        "stat_dod_structure": [307, 154],
        "stat_phi_n_structure": [38, 19, 10],
    },
    "test10": {
        "preprocess_dim": 2,
        "dod_structure": [62, 31],
        ...
        "pod_df_layers": [31, 16],
        "pod_in_channels": 1,
        "pod_hidden_channels": [10, 21],
        "pod_kernel": [3, 3], "pod_stride": [1, 2], "pod_padding": [1, 1],
        "pod_num_layers": 2,
        "L": 3,
        "stat_dod_structure": [333, 166],
        "stat_phi_n_structure": [42, 21, 10],
    },
    "test11": {
        "preprocess_dim": 2,
        "dod_structure": [67, 34],
        ...
        "pod_df_layers": [34, 17],
        "pod_in_channels": 1,
        "pod_hidden_channels": [11, 22],
        "pod_kernel": [3, 3], "pod_stride": [1, 2], "pod_padding": [1, 1],
        "pod_num_layers": 2,
        "L": 3,
        "stat_dod_structure": [358, 179],
        "stat_phi_n_structure": [45, 22, 11],
    },
    "test12": {
        "preprocess_dim": 2,
        "dod_structure": [77, 38],
        "df_layers": [26, 13],
        "dod_dl_df_layers": [13, 6],
        "dod_in_channels": 1,
        ...
        "pod_df_layers": [38, 19],
        "pod_in_channels": 1,
        "pod_hidden_channels": [13, 26],
        "pod_kernel": [3, 3], "pod_stride": [1, 2], "pod_padding": [1, 1],
        "pod_num_layers": 2,
        "L": 3,
        "stat_dod_structure": [410, 205],
        "stat_phi_n_structure": [51, 26, 13],
    },
    "test13": {
        "preprocess_dim": 2,
        "dod_structure": [86, 43],
        ...
        "pod_df_layers": [43, 22],
        "pod_in_channels": 1,
        "pod_hidden_channels": [14, 29],
        "pod_kernel": [3, 3], "pod_stride": [1, 2], "pod_padding": [1, 1],
        "pod_num_layers": 2,
        "L": 3,
        "stat_dod_structure": [461, 230],
        "stat_phi_n_structure": [58, 29, 14],
    },
    "test14": {
        "preprocess_dim": 2,
        "dod_structure": [96, 48],
        ...
        "pod_df_layers": [48, 24],
        "pod_in_channels": 1,
        "pod_hidden_channels": [16, 32],
        "pod_kernel": [3, 3], "pod_stride": [1, 2], "pod_padding": [1, 1],
        "pod_num_layers": 2,
        "L": 3,
        "stat_dod_structure": [512, 256],
        "stat_phi_n_structure": [64, 32, 16],
    },
    "test15": {
        "preprocess_dim": 2,
        "dod_structure": [106, 53],
        "df_layers": [35, 18],
        "dod_dl_df_layers": [18, 9],
        "dod_in_channels": 1,
        "dod_hidden_channels": 18,
        "dod_kernel": 3, "dod_stride": 1, "dod_padding": 1,
        "dod_num_layers": 1,
        "pod_df_layers": [53, 26],
        "pod_in_channels": 1,
        "pod_hidden_channels": [18, 35],
        "pod_kernel": [3, 3], "pod_stride": [1, 2], "pod_padding": [1, 1],
        "pod_num_layers": 2,
        "L": 3,
        "stat_dod_structure": [563, 282],
        "stat_phi_n_structure": [70, 35, 18],
    },
}
